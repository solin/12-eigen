...
%\subtitle{Iterative $hp$-FEM for Non-Symmetric Eigenvalue Problems}
\titlerunning{Iterative $hp$-FEM for Non-Symmetric Eigenvalue Problems} 
%\author{Pavel~Solin}
%
...
For any function $v\in V_n$ we can define a trivial prolongation operator $P$ such that $Pv\in V_n^U$ is the prolongation of $v$ in $V_n^U$ and similarly we can define the trivial prolongation operator $P^*$ from $V_n^*$ into $V_n^U$. %Let also denote the restriction operators $R:V_n^U\rightarrow V_n$ and $R^*:V_n^U\rightarrow V_n^*$ satisfying for $v\in V_n$ $v\equiv RPv$ and for $v\in V_n^*$ $v\equiv R^*P^*v$.
